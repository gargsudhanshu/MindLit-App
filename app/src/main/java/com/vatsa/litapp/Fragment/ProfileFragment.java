package com.vatsa.litapp.Fragment;
...
import com.vatsa.litapp.Activity.CfActivity;
import com.vatsa.litapp.Activity.StartActivity;
import com.vatsa.litapp.Adapter.MyFotosAdapter;
import com.vatsa.litapp.Activity.EditProfileActivity;
import com.vatsa.litapp.Activity.FollowersActivity;
import com.vatsa.litapp.Model.Post;
import com.vatsa.litapp.Model.User;
...
public class ProfileFragment extends Fragment {
    ...
    ImageView image_profile, logout, btn_cf;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        btn_cf = view.findViewById(R.id.btn_cf);
        ...
        btn_cf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getContext(), CfActivity.class));
            }
        });
